...
/// Handles the ickyness of accessing AURenderEvents without reading off the end
/// of the struct.
///
/// - Parameters:
...
void processRenderEvents(AURenderEvent *events, MidiFunc midiFunc,
                         SysexFunc sysexFunc, ParamFunc paramFunc) {
